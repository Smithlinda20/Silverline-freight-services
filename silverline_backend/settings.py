"""Django settings for SILVERLINE Freight Services."""
...
ROOT_URLCONF = 'silverline_backend.urls'
...
WSGI_APPLICATION = 'silverline_backend.wsgi.application'
...
INVOICE_TIME_ZONE = os.getenv("INVOICE_TIME_ZONE", "America/New_York")
